package com.easycredit.services.common.impl;
...
public class UploadFileServiceImpl implements UploadFileService {
	...
	public boolean uploadFile(String destinationDir, MultipartFile file, String filename) throws Exception {
		...
		// new File(realPath,
		// commentInfo.getAudioFile().getOriginalFilename()));
		try {
	...
	@Override
	public boolean uploadHandoutImg(String destinationDir, MultipartFile file, String filename, int widthTarget)
			throws Exception {
//		logger.info("文件长度: " + file.getSize());
//		logger.info("文件类型: " + file.getContentType());
//		logger.info("文件名称: " + file.getName());
...
//		logger.info("========================================");
	 ...
	 */
	private void SaveImgFromInputStream(InputStream stream, String path, String filename, int widthTarget)
			throws IOException {
		// path = "E:/test"; //test
		FileOutputStream outputStream = new FileOutputStream(path + "/" + filename);
