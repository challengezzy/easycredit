...
<div class="main">
	<div class="apply">
		<div class="apply-crumbs">
			<a href="#">产品申请</a>
			<span class="guide-sign">&gt;</span>信息确认
		</div>
		...
		<div class="apply-main">
			<form id="custInfoForm" action="${ctx}/product/applySubmit.html" method="post" id="uploadForm">
						...
						<div class="form-box" id="displayAttch1">
							...
							<c:forEach items="${s1}" var="obj" varStatus="status">
								<dl id="imagedl_${obj.id}" class="file-item">
									...
									<dt onclick="javascript:viewAttchImage('${fn:replace(obj.imageurl, '\\', '/')}');" 
										style="background-image:url(/${fn:split(fn:replace(obj.imageurl, '\\', '/'), '.')[0]}_210_100.jpg);" class="file-back">
									</dt>
								</dl>
							</c:forEach>
						</div>
				...
				<div class="form-action">
					<input id="preStepButton" onclick="javascript:submitPreStep();"
						class="blue-btn next-btn" value="上一步" type="button">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
					<input class="blue-btn submit-btn" id="submitLoanOrder" name="submitLoanOrder" value="提交审核" type="submit">
				</div>
			</form>
		</div>
	</div>
...
<script type="text/javascript">
	...
	function submitPreStep() {
	    $("#custInfoForm").attr("action", "/product/applyFourth.html");
	    $("#custInfoForm").submit();
	};
