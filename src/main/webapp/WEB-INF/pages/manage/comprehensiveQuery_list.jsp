...
<div id="wrap" > 
  ...
  <div class="container">
    <div class="row">
      ...
      <div class="col-md-10 ">
        <form id="mainForm" action="${ctx}/manage/comprehensive/getComprehensiveList.html"  method="post" id="mainForm">
	    <div class="panel panel-default">
	      <div class="panel-heading ">综合查询统计 </div>
	      <div class="form-inline popover-show panel-body list_toolbar">
	        ...
	        <div class="form-group width_input"  data-toggle="popover"  data-placement="top" data-content="请输入借据ID">
	          <input  class="form-control" type="text"  placeholder="借据ID" name="loanno" value="${param.loanno}"/>
	        </div>
	        ...
	        <div class="form-group width_input"  data-toggle="popover"  data-placement="top" data-content="请输入客户经理名称">
	          <input  class="form-control" type="text"  placeholder="归属客户经理" name="operatorname" value="${param.operatorname}"/>
	        </div>
	        <div class="form-group width_input"  data-toggle="popover"  data-placement="top" data-content="请输入归属公司名称">
	          <input  class="form-control" type="text"  placeholder="归属公司" name="operatorcompanyname" value="${param.operatorcompanyname}"/>
	        </div>
