...
<div id="wrap" > 
  ...
  <div class="container">
    <div class="row">
      ...
      <div class="col-md-10 ">
       <form role="form" action="${ctx}/manage/security/organizationauthority/getOrganizationauthoritys.html" method="post" id="mainForm">
	    <div class="panel panel-default">
	      <div class="panel-heading ">用户组权限分配 </div>
	          ...
	          <tbody>
				<c:forEach items="${page.result}" var="obj" varStatus="status">
		            <tr class="text-center">
		              ...
		              <td>${obj.authoritytypeflags}</td>
		              <td>
		             	<div class="btn-group btn-group-sm pull-center btn-edit-list">
		               		<a href="#" data-toggle="modal" data-target="#modal_alert" data-backdrop="static" data-load-remote="/manage/security/organizationauthority/authoritylist.html?organizationid=${obj.organizationid}">分配权限</a> 
						</div>
		              </td>
		            </tr>
	           	</c:forEach>
