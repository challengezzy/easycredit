...
<%@ page language="java" import="org.springframework.web.context.request.ServletRequestAttributes,org.springframework.web.context.request.RequestContextHolder,com.easycredit.utils.Page"%>
<ul class="pagination">
<%
  	...
  	if(pageObj!=null && pageObj.getResult().size()>0){
        ...
        out.print("<span class=\"pull-right page_num_info badge\">共"+pageObj.getTotalPages()+"页，共"+pageObj.getTotalCount()+"条记录</span>");
        
        out.print("<input type=\"hidden\" name=\"pageNum\" id=\"pageNo\" value="+pageObj.getPageNo()+" />");
